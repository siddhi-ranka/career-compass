      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
        ...
        <div className="container relative z-10 px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              SkillPath analyzes your skills, identifies gaps, and creates a personalized 
              learning roadmap to help you land your dream job.
            </motion.p>
            ...
            >
              {[
                { icon: Target, label: "Skill Gap Analysis", desc: "Identify missing skills" },
                { icon: Zap, label: "Smart Roadmaps", desc: "Personalized learning paths" },
                { icon: Sparkles, label: "AI Career Mentor", desc: "24/7 guidance support" },
              ].map((feature, index) => (
                <motion.div
                  key={feature.label}
                  initial={{ opacity: 0, y: 20 }}
                  ...
                  className="glass rounded-xl p-5 hover:bg-foreground/5 transition-colors"
                >
